...
var PM = PasskeysManager.shared

class PasskeysManager:NSObject, ObservableObject, ASAuthorizationControllerPresentationContextProviding, ASAuthorizationControllerDelegate {
   
    static let shared = PasskeysManager()
   ...
   func createSignUp(userName: String, userId: Data, challenge: Data, relyingParty:String){
       
   }
   

    // https://developer.apple.com/documentation/authenticationservices/supporting-passkeys
   func signUpWith(userName: String, userId: Data, challenge: Data, relyingParty:String, anchor: ASPresentationAnchor) {
   ...
   func signInWith(anchor: ASPresentationAnchor, challenge: Data, allowedCredentials:[String] = [], relyingParty:String, preferImmediatelyAvailableCredentials: Bool) {
       self.authenticationAnchor = anchor
   ...
   func authorizationController(controller: ASAuthorizationController, didCompleteWithAuthorization authorization: ASAuthorization){
       switch authorization.credential {
         case let credentialRegistration as ASAuthorizationPlatformPublicKeyCredentialRegistration:
           ...
           let registerAttest = Attestation(id: credentialID.base64URLEncode(),
//                                            rawId: credentialID.base64URLEncode(),
//                                            authenticatorAttachment: "platform",
//                                            type: "public-key",
                                            response: AttestReponse(attestationObject: attestationObject.base64URLEncode(), clientDataJSON: clientDataJSON.base64URLEncode()))
...
//                          "rawId": credentialID.base64URLEncode(), // Base64URL
...
//                          "type": "public-key",
           ...
           if let payloadJSONData = try? JSONSerialization.data(withJSONObject: payload, options: .fragmentsAllowed) {
               ...
               self.assertion = Assertion(id: credentialID.base64URLEncode(),
//                                          rawId: credentialID.base64URLEncode(),
//                                          authenticatorAttachment: "platform",
//                                          type: "public-key",
                                          response: AssertResponse(authenticatorData: authenticatorData.base64URLEncode(),
                                                                   clientDataJSON: clientDataJSON.base64URLEncode(),
                                                                   signature:signature.base64URLEncode(),
                                                                   userHandle:userID.base64URLEncode()))
